    ...
    <View style={[styles.container, { height: windowHeight }]}>
      <View style={styles.div}>
        ...
        <View style={styles.inputContainer}>
          <Ionicons name="person" size={20} color="#000" style={{ marginRight: 10, marginTop: 5 }} />
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput placeholder="Email" pattern={"[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$"} style={styles.input} onChangeText={(text)=>setEmail(text)}/>
        </View>
        <View style={styles.inputContainer}>
        ...
        <Text style={styles.text}>Already have an account? 
          <Text style={{ color: '#000', fontWeight: 'bold' }} onPress={() => navigation.navigate('LoginG')}> Log In</Text>
        </Text>
      </View>
    </View>
  );
